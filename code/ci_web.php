...
<?
	...
	*****************************************************************************************/
	...
	$Okurl 			= "okurl.php";		//성공URL : 결제완료통보페이지 full Url (예:http://www.mcash.co.kr/okurl.jsp )	
	...
	*****************************************************************************************/
	...
	$CALL_TYPE	= ""; 		//결제창 호출방식( SELF 페이지전환 , P 팝업 )
...
<form name="payForm" accept-charset='euc-kr'>
 ...
 <table border="1" width="100%">
	...
	<tr>
 	...
 	<tr>
 		<td align="center" colspan="6"><input type="button" value="인증하기" onclick="payRequest()"></td>
 	</tr> 	
 </table>
